...
\begin{document}
	...
	\begin{abstract}
		% THIS PAPER
		%Quantum computers are expensive to run in practice, motivating us to minimize the amount of resources required to execute quantum algorithms. 
...
% The leading proposol for fault-tolerant quantum computation partitions encoded (protected from noise) quantum operations into so called Clifford operations and magic state 
...
\subsection{Time-Ordered Order Lowering (TOOL)}% Time-Ordered Order Lowering (TOOL)
